...
public partial class Ckeditor_LinkBrowser : System.Web.UI.Page
{
    ...
    protected void SelectImage(object sender, EventArgs e)
    {
        ...
        OkButton.OnClientClick = "window.top.opener.CKEDITOR.dialog.getCurrent().setValueOf('info', 'url', encodeURI('" + ConfigurationManager.AppSettings["TemplateFilepath"] + link + "')); window.top.close(); window.top.opener.focus();";
    }
