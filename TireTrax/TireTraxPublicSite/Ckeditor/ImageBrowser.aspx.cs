...
public partial class Ckeditor_ImageBrowser : System.Web.UI.Page
{
    ...
    protected void SelectImage(object sender, EventArgs e)
    {
        ...
        OkButton.OnClientClick = "window.top.opener.CKEDITOR.dialog.getCurrent().setValueOf('info', 'txtUrl', encodeURI('" + ConfigurationManager.AppSettings["TemplateFilepath"] + ImageFolder + ImageList.SelectedValue.Replace("'", "\\'") + "')); window.top.close(); window.top.opener.focus();";
    }
