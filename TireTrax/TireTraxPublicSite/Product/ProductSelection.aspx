<%@ Page Title="" Language="C#" MasterPageFile="~/master.master" AutoEventWireup="true"
    CodeFile="ProductSelection.aspx.cs" Inherits="ProductSelection_ProductSelection" %>
                        ...
                        <div class="ibox float-e-margins">
                            ...
                            <div class="ibox-content ">
                                ...
                                <asp:LinkButton ID="lnkAddProductsForStewardship" runat="server" CssClass="btn btn-primary btn-sm font-bold" CausesValidation="true"
                                    ValidationGroup="OrgProducts" OnClick="lnkAddProductsForStewardship_Click"><%= ResourceMgr.GetMessage("Save")%></asp:LinkButton>
                            ...
                            <div class="ibox-content">
                                <div class="">
                                    ...
                                    <asp:DropDownList ID="ddlProducts" runat="server" OnSelectedIndexChanged="ddlProducts_SelectedIndexChanged" AutoPostBack="True"
                                        Width="30%" CssClass="form-control">
                                    </asp:DropDownList>

                                    <br />
                                    <asp:CheckBoxList ID="chkProducts" runat="server" Visible="false" Width="35%" class="prod-type-chkbox " RepeatColumns="2"
                                    ...
                                    <cc1:ResourceCustomValidator ID="checkselect"
                                        ...
                                        Display="Dynamic" ValidationGroup="ProductSelection" ClientValidationFunction="ValidateCheckBoxList1"> </cc1:ResourceCustomValidator>
                                    ...
                                    <div class="form-group" id="divButtons" runat="server" visible="false">
                                        <asp:LinkButton ID="lnkAddProduct" runat="server" ValidationGroup="ProductSelection"
                                        ...
                                        <asp:LinkButton ID="lnkCancel" runat="server" CausesValidation="false" OnClick="lnkCancel_Click"
                            ...
                            <div class="col-lg-12">
                                ...
                                <div id="divSizeShapeMaterialBrand" runat="server" visible="false">
                                    <div class="col-md-3">
                                        ...
                                        <cc1:ResourceRequiredFieldValidator ID="rfv1" runat="server" ControlToValidate="txtSize" ValidationGroup="Size" Display="Dynamic" ErrorMessage="Please enter size" CssClass="custom-block-error"></cc1:ResourceRequiredFieldValidator>
                                        <br />
                                ...
                                <asp:TextBox ID="txtSizeDescription" runat="server" CssClass="form-control"></asp:TextBox><br />--%>
                                    ...
                                    <div class="col-md-3" style="border-left: 1px solid black">
                                        ...
                                        <cc1:ResourceRequiredFieldValidator ID="rfv2" runat="server" ControlToValidate="txtShape" ValidationGroup="Shape" Display="Dynamic" ErrorMessage="Please enter shape" CssClass="custom-block-error"></cc1:ResourceRequiredFieldValidator>
                                        <br />
                                        <%--<label>Description</label>
                                <asp:TextBox ID="txtShapeDescription" runat="server" CssClass="form-control"></asp:TextBox><br />--%>
                                    ...
                                    <div class="col-md-3" style="border-left: 1px solid black">
                                        ...
                                        <cc1:ResourceRequiredFieldValidator ID="rfv3" runat="server" ControlToValidate="txtMaterial" ValidationGroup="Material" Display="Dynamic" ErrorMessage="Please enter material" CssClass="custom-block-error"></cc1:ResourceRequiredFieldValidator>
                                        <br />
                                        <%--<label>Description</label>
                                <asp:TextBox ID="txtMaterialDescription" runat="server" CssClass="form-control"></asp:TextBox><br />--%>
                                    ...
                                    <div class="col-md-3" style="border-left: 1px solid black">
                                        ...
                                        <cc1:ResourceRequiredFieldValidator ID="rfv4" runat="server" ControlToValidate="txtBrand" ValidationGroup="Brand" Display="Dynamic" ErrorMessage="Please enter brand" CssClass="custom-block-error"></cc1:ResourceRequiredFieldValidator>
                                        <br />
                                        <%--<label>Description</label>
                        ...
                        <div class="modal-body">
                            <div role="form" class="row search-filter" id="">
                                <div class="form-group col-md-6">
                                    ...
                                    <br />
                                    <label><%= ResourceMgr.GetMessage("Product Sub Type Name")%></label>
                                    ...
                                    <br />
                                    <br />
                                    <label><%= ResourceMgr.GetMessage("Product Sub Type Description")%></label>
