<%@ Page Title="" Language="C#" MasterPageFile="~/skeleton.master" AutoEventWireup="true"
    CodeFile="RegistrationFormCA.aspx.cs" Inherits="Registration_RegistrationFormCA" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        function SetWizard(ddl) {
            ...
            if ($(ddl).val() == "0" || $(ddl).children("option:selected").text().indexOf("Consumer") != -1) {
                ...
                if ($(ddl).val() == "0" || $(ddl).children("option:selected").text().indexOf("Stakeholder") != -1) {
                    ...
                    if ($(ddl).children("option:selected").
                        text().indexOf("Law Enforcement Agency") != -1 || $(ddl).children("option:selected").text().indexOf("Government Agency") != -1) {
    ...
    function HideClientZipCodeLabel() {
        ...
        function ValidatePrimaryContactSameOrNot(sender, args) {
            if ($("#<%=txtPrimaryContactBusinessPhone1.ClientID%>").val() == $("#<%=txtPrimaryContactCellPhone1.ClientID%>").val() && $("#<%=txtPrimaryContactBusinessPhone1.ClientID%>").val() != $("#<%=txtPrimaryContactBusinessPhone1.ClientID%>").attr("WaterMarkText") && $("#<%=txtPrimaryContactCellPhone1.ClientID%>").val() != $("#<%=txtPrimaryContactCellPhone1.ClientID%>").attr("WaterMarkText") && $("#<%=txtPrimaryContactBusinessPhone2.ClientID %>").val() != $("#<%=txtPrimaryContactBusinessPhone2.ClientID %>").attr("WaterMarkText") && $("#<%=txtPrimaryContactBusinessPhone2.ClientID %>").val() == $("#<%= txtPrimaryContactCellPhone2.ClientID%>").val() && $("#<%= txtPrimaryContactCellPhone2.ClientID%>").val() != $("#<%= txtPrimaryContactCellPhone2.ClientID%>").attr("WaterMarkText") && $("#<%=txtPrimaryContactBusinessPhone3.ClientID%>").val() == $("#<%=txtPrimaryContactCellPhone3.ClientID%>").val() && $("#<%=txtPrimaryContactBusinessPhone3.ClientID%>").val() != $("#<%=txtPrimaryContactBusinessPhone3.ClientID%>").attr("WaterMarkText") && $("#<%=txtPrimaryContactCellPhone3.ClientID%>").val() != $("#<%=txtPrimaryContactCellPhone3.ClientID%>").attr("WaterMarkText")) {
                args.IsValid = false;
            }
        }
        function ValidateBillingContactSameOrNot(sender, args) {
            if ($("#<%=txtBillingContactPhoneNumber1.ClientID%>").val() != $("#<%=txtBillingContactPhoneNumber1.ClientID%>").attr("WaterMarkText") && $("#<%=txtBillingContactPhoneNumber1.ClientID%>").val() == $("#<%=txtBillingContactCellNumber1.ClientID%>").val() && $("#<%=txtBillingContactCellNumber1.ClientID%>").val() != $("#<%=txtBillingContactCellNumber1.ClientID%>").attr("WaterMarkText") && $("#<%=txtBillingContactPhoneNumber2.ClientID %>").val() != $("#<%=txtBillingContactPhoneNumber2.ClientID %>").attr("WaterMarkText") && $("#<%=txtBillingContactPhoneNumber2.ClientID %>").val() == $("#<%= txtBillingContactCellNumber2.ClientID%>").val() && $("#<%= txtBillingContactCellNumber2.ClientID%>").val() != $("#<%= txtBillingContactCellNumber2.ClientID%>").attr("WaterMarkText") && $("#<%=txtBillingContactPhoneNumber3.ClientID%>").val() != $("#<%=txtBillingContactPhoneNumber3.ClientID%>").attr("WaterMarkText") && $("#<%=txtBillingContactPhoneNumber3.ClientID%>").val() == $("#<%=txtBillingContactCellNumber3.ClientID%>").val() && $("#<%=txtBillingContactCellNumber3.ClientID%>").val() != $("#<%=txtBillingContactCellNumber3.ClientID%>").attr("WaterMarkText")) {
        ...
        function ValidateLocationBusinessPhoneSameOrNot(sender, args) {
            if ($("#<%=txtLocationBusinessPhone1.ClientID%>").val() != $("#<%=txtLocationBusinessPhone1.ClientID%>").attr("WaterMarkText") && $("#<%=txtLocationBusinessPhone1.ClientID%>").val() == $("#<%=txtLocationCellPhone1.ClientID%>").val() && $("#<%=txtLocationCellPhone1.ClientID%>").val() != $("#<%=txtLocationCellPhone1.ClientID%>").attr("WaterMarkText") && $("#<%=txtLocationBusinessPhone2.ClientID %>").val() != $("#<%=txtLocationBusinessPhone2.ClientID %>").attr("WaterMarkText") && $("#<%=txtLocationBusinessPhone2.ClientID %>").val() == $("#<%= txtLocationCellPhone2.ClientID%>").val() && $("#<%= txtLocationCellPhone2.ClientID%>").val() != $("#<%= txtLocationCellPhone2.ClientID%>").attr("WaterMarkText") && $("#<%=txtLocationBusinessPhone3.ClientID%>").val() != $("#<%=txtLocationBusinessPhone3.ClientID%>").attr("WaterMarkText") && $("#<%=txtLocationBusinessPhone3.ClientID%>").val() == $("#<%=txtLocationCellPhone3.ClientID%>").val() && $("#<%=txtLocationCellPhone3.ClientID%>").val() != $("#<%=txtLocationCellPhone3.ClientID%>").attr("WaterMarkText")) {
        ...
        function ValidateSupplierBusinessPhoneSameOrNot(sender, args) {

            if ($("#<%=txtSupplierBusinessPhone1.ClientID%>").val() != $("#<%=txtSupplierBusinessPhone1.ClientID%>").attr("WaterMarkText") && $("#<%=txtSupplierBusinessPhone1.ClientID%>").val() == $("#<%=txtSupplierContactCellPhone1.ClientID%>").val() && $("#<%=txtSupplierContactCellPhone1.ClientID%>").val() != $("#<%=txtSupplierContactCellPhone1.ClientID%>").attr("WaterMarkText") && $("#<%=txtSupplierBusinessPhone2.ClientID %>").val() != $("#<%=txtSupplierBusinessPhone2.ClientID %>").attr("WaterMarkText") && $("#<%=txtSupplierBusinessPhone2.ClientID %>").val() == $("#<%= txtSupplierContactCellPhone2.ClientID%>").val() && $("#<%= txtSupplierContactCellPhone2.ClientID%>").val() != $("#<%= txtSupplierContactCellPhone2.ClientID%>").attr("WaterMarkText") && $("#<%= txtSupplierBusinessPhone3.ClientID%>").val() != $("#<%= txtSupplierBusinessPhone3.ClientID%>").attr("WaterMarkText") && $("#<%= txtSupplierBusinessPhone3.ClientID%>").val() == $("#<%=txtSupplierContactCellPhone3.ClientID%>").val() && $("#<%=txtSupplierContactCellPhone3.ClientID%>").val() != $("#<%=txtSupplierContactCellPhone3.ClientID%>").attr("WaterMarkText")) {

                args.IsValid = false
            }
        }

        function ValidateClientBusinessPhoneSameOrNot(sender, args) {
            if ($("#<%=txtClientBusinessPhone1.ClientID%>").val() != $("#<%=txtClientBusinessPhone1.ClientID%>").attr("WaterMarkText") && $("#<%=txtClientBusinessPhone1.ClientID%>").val() == $("#<%=txtClientCellPhone1.ClientID%>").val() && $("#<%=txtClientCellPhone1.ClientID%>").val() != $("#<%=txtClientCellPhone1.ClientID%>").attr("WaterMarkText") && $("#<%=txtClientBusinessPhone2.ClientID %>").val() != $("#<%=txtClientBusinessPhone2.ClientID %>").attr("WaterMarkText") && $("#<%=txtClientBusinessPhone2.ClientID %>").val() == $("#<%= txtClientCellPhone2.ClientID%>").val() && $("#<%= txtClientCellPhone2.ClientID%>").val() != $("#<%= txtClientCellPhone2.ClientID%>").attr("WaterMarkText") && $("#<%= txtClientBusinessPhone3.ClientID%>").val() != $("#<%= txtClientBusinessPhone3.ClientID%>").val() && $("#<%= txtClientBusinessPhone3.ClientID%>").val() == $("#<%=txtClientCellPhone3.ClientID%>").val() && $("#<%=txtClientCellPhone3.ClientID%>").val() != $("#<%=txtClientCellPhone3.ClientID%>").attr("WaterMarkText")) {
            ...
            <div class="wrapper wrapper-content animated fadeInRight reg">
                <div class="panel-heading p0">
                    <div class="panel-options">
                        <ul class="nav nav-tabs" data-connect="breadcrumbcontent">
                            ...
                            <li id="li2"><a data-toggle="tab" href="#tab-2">
                            ...
                            <li id="li4"><a data-toggle="tab" href="#tab-4" validationgroup="Stakeholders">
                                <%= ResourceMgr.GetMessage("Stakeholders")%></a></li>
                            <li id="li5"><a data-toggle="tab" href="#tab-5" validationgroup="Step3">
                                <%= ResourceMgr.GetMessage("Suppliers")%></a></li>
                            <li id="li6"><a data-toggle="tab" href="#tab-6" validationgroup="Step4">
                ...
                <div id="breadcrumbcontent" class="tab-content">
                                        ...
                                        <div class="cmp_info_form">
                                            <div class="row">
                                                <div class="col-md-5">
                                                    <div class="form-horizontal">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <asp:TextBox ID="txtBusinessLegalName" runat="server" CssClass="form-control"></asp:TextBox>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <button onclick="SetDBANameAsBusinessName();" type="button" class="btn btn-sm btn-white">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <asp:DropDownList ID="ddlOrganizationType" runat="server" CssClass="form-control" onchange="SetWizard(this);">
                                                                </asp:DropDownList>
                                                        ...
                                                        <div class="form-group" id="orgsubType" runat="server">
                                                            <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("Organization Type:")%></label>
                                                            <div class="col-sm-7">
                                                        ...
                                                        <div class="col-sm-7">
                                                            ...
                                                            <cc1:ResourceCustomValidator ID="ResourceCustomValidator23"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <asp:TextBox ID="txtPrimaryContactFirstName" runat="server" placeholder='<%# ResourceMgr.GetError("First Name") %>'
                                                                            CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <asp:TextBox ID="txtPrimaryContactLastName" runat="server" placeholder='<%# ResourceMgr.GetError("Last Name") %>'
                                                                            CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                                <cc1:ResourceCustomValidator ID="ResourceCustomValidator15" runat="server" ValidationGroup="PrimaryRegistartion"
                                                                    Display="Dynamic" CssClass="custom-block-error"
                                                                    ClientValidationFunction="ValidatePrimaryContactName">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <asp:DropDownList ID="ddlPrimaryContactTitle" runat="server" CssClass="form-control">
                                                                </asp:DropDownList>
                                                                <cc1:ResourceRequiredFieldValidator ID="ResourceRequiredFieldValidator9" runat="server" ControlToValidate="ddlPrimaryContactTitle"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                ...
                                                                <%= ResourceMgr.GetMessage("Please enter Primary Contact Phone")%></cc1:ResourceCustomValidator>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <asp:TextBox ID="txtPrimaryContactCellPhone2" runat="server" CssClass="form-control text-center"
                                                                            MaxLength="3" placeholder="000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <asp:TextBox ID="txtPrimaryContactCellPhone3" runat="server" CssClass="form-control text-center"
                                                                            MaxLength="4" placeholder="0000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                                    </div>

                                                                </div>
                                                                <cc1:ResourceCustomValidator ID="ResourceCustomValidator2" runat="server" ValidationGroup="PrimaryRegistartion"
                                                                    Display="Dynamic" CssClass="custom-block-error" ClientValidationFunction="ValidatePrimaryCellPhone"></cc1:ResourceCustomValidator>
                                                              <%--  <cc1:ResourceCustomValidator ID="ResourceCustomValidator13" runat="server" ValidationGroup="PrimaryRegistartion"
                                                                    Display="Dynamic" CssClass="custom-block-error"
                                                                    ClientValidationFunction="ValidatePrimaryContactSameOrNot">
                                                                <%= ResourceMgr.GetError("Please enter different Phone Numbers")%></cc1:ResourceCustomValidator>--%>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <label class="checkbox">
                                                                    <asp:CheckBox ID="chkPrimaryContactAcceptTextMessages" runat="server" CssClass="m-l-md" />
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <asp:TextBox ID="txtBillingContactFirstName" runat="server" placeholder='<%# ResourceMgr.GetError("First Name")%>'
                                                                            CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-md-6">
                                                                        <asp:TextBox ID="txtBillingContactLastName" runat="server" placeholder='<%# ResourceMgr.GetError("Last Name")%>'
                                                                            CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("Title:")%></label>
                                                            <div class="col-sm-7">
                                                                <asp:DropDownList ID="ddlBillingContactTitle" runat="server" CssClass="form-control">
                                                                </asp:DropDownList>
                                                                <cc1:ResourceRequiredFieldValidator ID="ResourceRequiredFieldValidator14" runat="server"
                                                                    ControlToValidate="ddlBillingContactTitle" InitialValueErrorText="0"
                                                                    ValidationGroup="PrimaryRegistartion" Display="Dynamic" CssClass="custom-block-error">
                                                                <%= ResourceMgr.GetError("Please select Title")%>
                                                                </cc1:ResourceRequiredFieldValidator>
                                                            </div>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("Billing Phone:")%></label>
                                                            <div class="col-sm-7">
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <asp:TextBox ID="txtBillingContactPhoneNumber1" runat="server" CssClass="form-control text-center"
                                                                            placeholder="000" MaxLength="3" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <asp:TextBox ID="txtBillingContactPhoneNumber2" runat="server" CssClass="form-control text-center"
                                                                            placeholder="000" MaxLength="3" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <asp:TextBox ID="txtBillingContactPhoneNumber3" runat="server" CssClass="form-control text-center"
                                                                            placeholder="0000" MaxLength="4" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <div class="row">
                                                                    <div class="col-md-4">
                                                                        <asp:TextBox ID="txtBillingContactCellNumber1" runat="server" CssClass="form-control text-center"
                                                                            MaxLength="3" placeholder="000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <asp:TextBox ID="txtBillingContactCellNumber2" runat="server" CssClass="form-control text-center"
                                                                            MaxLength="3" placeholder="000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                                    </div>
                                                                    <div class="col-md-4">
                                                                        <asp:TextBox ID="txtBillingContactCellNumber3" runat="server" CssClass="form-control text-center"
                                                                            MaxLength="4" placeholder="0000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                               ...
                                                               <%-- <cc1:ResourceCustomValidator ID="ResourceCustomValidator14" runat="server" ValidationGroup="PrimaryRegistartion"
                                                                    Display="Dynamic" CssClass="custom-block-error"
                                                                    ClientValidationFunction="ValidateBillingContactSameOrNot">
                                                                <%= ResourceMgr.GetError("Please enter different Phone Numbers")%>
                                                                </cc1:ResourceCustomValidator>--%>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <label class="checkbox">
                                                                    <asp:CheckBox ID="chkBillingContactAcceptTextMessages" runat="server" CssClass="m-l-md" />
                                                                    <%= ResourceMgr.GetMessage("Yes")%>
                                                                </label>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <asp:TextBox ID="txtBillingContactEmail" runat="server" CssClass="form-control"></asp:TextBox>
                                                ...
                                                <div class="col-md-5 col-md-offset-2">
                                                    <div class="form-horizontal">
                                                        <div class="form-group">
                                                            <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("Facility Postal Code:")%></label>
                                                            <div class="col-sm-7">

                                                                <asp:TextBox ID="txtBusinessZipCode" runat="server" CssClass="form-control" onblur="HideBusinessZipCodeLabel();" AutoPostBack="true" OnTextChanged="txtBusinessZipCode_TextChanged" CausesValidation="true" ValidationGroup="AdditionalInfoBusinessZipCode"></asp:TextBox>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <asp:TextBox ID="txtBusinessAddress1" runat="server" placeholder='<%# ResourceMgr.GetError("Primary physical location Street # - Street name")%>' CssClass="form-control"></asp:TextBox>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <asp:TextBox ID="txtBusinessAddress2" runat="server" CssClass="form-control"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("City:")%></label>
                                                            <div class="col-sm-7">
                                                                <asp:TextBox ID="txtBuinessCity" Enabled="false" runat="server" CssClass="form-control"></asp:TextBox>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <asp:DropDownList ID="ddlBusinessProvince" Enabled="false" runat="server" CssClass="form-control"></asp:DropDownList>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <asp:DropDownList ID="ddlBusinessCountry" Enabled="false" runat="server" CssClass="form-control"></asp:DropDownList><br />
                                                        ...
                                                        <!-- Update Panel -->
                                                        <asp:UpdatePanel ID="upnlBillingContact" runat="server" UpdateMode="Conditional">
                                                            <ContentTemplate>
                                                                <div class="form-group">
                                                                    <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("Mailing ZIP Code:")%> </label>
                                                                    <div class="col-sm-7">
                                                                        <asp:TextBox ID="txtMailingZipCode" runat="server" CssClass="form-control" onblur="HideMailingZipCodeLabel();" AutoPostBack="true" OnTextChanged="txtMailingZipCode_TextChanged" CausesValidation="true" ValidationGroup="MailingZipCode"></asp:TextBox><asp:HiddenField ID="hdnMailingZipCodeId" runat="server" Value="" />
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-7">
                                                                        <asp:TextBox ID="txtMailingAddress1" runat="server" CssClass="form-control" placeholder='<%# ResourceMgr.GetError("Mailing Street# - Street name") %>' MaxLength="200"></asp:TextBox>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="col-sm-7">
                                                                        <asp:TextBox ID="txtMailingAddress2" runat="server" CssClass="form-control"></asp:TextBox>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("City:")%></label>
                                                                ...
                                                                <div class="form-group">
                                                                    <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("Country:")%> </label>
                                                                    <div class="col-sm-7">
                                                                        <asp:DropDownList Enabled="false" ID="ddlMailingCountry" runat="server" CssClass="form-control"></asp:DropDownList>
                                                            ...
                                                            <Triggers>
                                                                <asp:AsyncPostBackTrigger ControlID="txtMailingZipCode" EventName="TextChanged" />
                                                                <asp:AsyncPostBackTrigger ControlID="rslnkbtnBillingSameAsFacility" EventName="Click" />
                                                            </Triggers>
                                                        </asp:UpdatePanel>
                                                        <!-- // End Update Panel -->
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <asp:TextBox ID="txtBusinessWebsite" runat="server" CssClass="form-control"></asp:TextBox>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("Accounting Interface:")%></label>
                                                            <div class="col-sm-7">
                                                                <asp:DropDownList ID="ddlBusinessAccountingInterface" runat="server" CssClass="form-control">
                                                                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <asp:DropDownList ID="ddlBusinessInventoryInterface" runat="server" CssClass="form-control">
                                                                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-sm-7">
                                                                <label class="checkbox">
                                                                    <asp:CheckBox CssClass="m-l-md" ID="chkBusinessAcceptAutoFundTransfers" runat="server" />
                                                                    <%= ResourceMgr.GetMessage("Yes")%>
                                                                </label>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row text-right">
                                                <div class="col-md-12">
                                                    ...
                                                    <cc1:ResourceLinkButton CssClass="btn btn-primary" ID="lnkbtnStep1" ValidationGroup="PrimaryRegistartion"
                                                        runat="server" OnClick="lnkbtnStep1_Click" OnClientClick="GotoNextStep(1,'PrimaryRegistartion');">
                                                    <%= ResourceMgr.GetMessage("Next") %>
                                                    </cc1:ResourceLinkButton>
                    ...
                    <div id="tab-2" class="tab-pane">
                        <div class="mail-box-header">
                            <div class="pull-right tooltip-demo">
                                <label class="badge badge-primary pull-right cuse8steps">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <asp:TextBox ID="txtLocationBusinessName" runat="server" CssClass="form-control"></asp:TextBox>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="row">
                                                        <div class="col-md-8">
                                                            <asp:TextBox ID="txtLocationDBAName" runat="server" CssClass="form-control"></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <div class="btn btn-sm btn-white" onclick="SetAdditionalLocationDBANameAsBusinessName();"><%= ResourceMgr.GetMessage("Same")%></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <label class="checkbox-inline">
                                                        <asp:CheckBox ID="chkLocationPermanent" AutoPostBack="false" CausesValidation="false" runat="server" />
                                                        <%= ResourceMgr.GetMessage("Permanent")%>
                                                    </label>
                                                    <label class="checkbox-inline">
                                                        <asp:CheckBox ID="chkLocationTemporary" CausesValidation="false" AutoPostBack="false" runat="server" />
                                            ...
                                            <div class="form-group" id="dvDateRange">
                                                <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("Location Event:")%></label>
                                                <div class="col-sm-7">
                                                    <asp:DropDownList ID="ddlLocationEventType" runat="server" CssClass="form-control">
                                                    </asp:DropDownList>
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <asp:TextBox ID="txtLocationFromDate" runat="server" CssClass="form-control"
                                                                placeholder='<%# ResourceMgr.GetError("From") %>'></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <asp:TextBox ID="txtLocationToDate" runat="server" CssClass="form-control"
                                                                placeholder='<%# ResourceMgr.GetError("To")%>'></asp:TextBox>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <asp:TextBox ID="txtLocationContactFirstName" runat="server" placeholder='<%# ResourceMgr.GetError("First Name") %>'
                                                                CssClass="form-control"></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <asp:TextBox ID="txtLocationContactLastName" runat="server" placeholder='<%# ResourceMgr.GetError("Last Name")%>'
                                                                CssClass="form-control"></asp:TextBox>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("Title:")%></label>
                                                <div class="col-sm-7">
                                                    <asp:DropDownList ID="ddlLocationContactTitle" runat="server" CssClass="form-control">
                                                    </asp:DropDownList>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <asp:TextBox ID="txtLocationBusinessPhone1" runat="server" CssClass="form-control text-center" MaxLength="3"
                                                                placeholder="000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <asp:TextBox ID="txtLocationBusinessPhone2" runat="server" CssClass="form-control text-center" MaxLength="3"
                                                                placeholder="000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <asp:TextBox ID="txtLocationBusinessPhone3" runat="server" CssClass="form-control text-center" MaxLength="4"
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("Extension:")%></label>
                                                <div class="col-sm-7">
                                                    <asp:TextBox ID="txtLocationBusinessPhoneExtension" runat="server" CssClass="form-control" MaxLength="4" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("Cell Phone:")%></label>
                                                <div class="col-sm-7">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <asp:TextBox ID="txtLocationCellPhone1" runat="server" CssClass="form-control text-center" MaxLength="3"
                                                                placeholder="000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <asp:TextBox ID="txtLocationCellPhone2" runat="server" CssClass="form-control text-center" MaxLength="3"
                                                                placeholder="000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <asp:TextBox ID="txtLocationCellPhone3" runat="server" CssClass="form-control text-center" MaxLength="4"
                                                                placeholder="0000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <cc1:ResourceCustomValidator ID="ResourceCustomValidator20" runat="server" ValidationGroup="AdditionalLocation"
                                                        Display="Dynamic" CssClass="custom-block-error"
                                                        ClientValidationFunction="ValidateLocationBusinessPhoneSameOrNot"><%= ResourceMgr.GetError("Please enter different Phone Numbers")%></cc1:ResourceCustomValidator>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("Accept Text Messages:")%></label>
                                                ...
                                                <ContentTemplate>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            ...
                                                            <cc1:ResourceRequiredFieldValidator ID="ResourceRequiredFieldValidator22" runat="server" InitialValueErrorText="Primary physical location Street # - Street name" ControlToValidate="txtLocationAddress1" ValidationGroup="AdditionalLocation" ErrorText="Please enter Address" Display="Dynamic" CssClass="custom-block-error"></cc1:ResourceRequiredFieldValidator>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("Suit #:") %></label>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("Country:")%></label>
                                                        <div class="col-sm-7">
                                                            <asp:DropDownList ID="ddlLocationCountry" Enabled="false" runat="server" CssClass="form-control"></asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </ContentTemplate>
                                                <Triggers>
                                        ...
                                        <asp:UpdatePanel ID="upnlLocation" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <div class="row-fluid text-right">
                                                    <cc1:ResourceLinkButton CssClass="btn btn-sm btn-primary font-bold" ID="lnkBtnLocationAdd" runat="server" CausesValidation="true"
                                                        ValidationGroup="AdditionalLocation" OnClick="lnkBtnLocationAdd_Click"> <%=ResourceMgr.GetMessage("Add this Location") %></cc1:ResourceLinkButton>
                                                </div>
                                                <div class="table-responsive m-t-md">
                                                    <asp:GridView ID="gvAdditionLocations" runat="server" ShowHeaderWhenEmpty="true" AutoGenerateColumns="false" CssClass="table table-bordered epr-sec-table" CellPadding="0" CellSpacing="0" BorderWidth="0" Width="100%" OnRowCommand="gvAdditionLocations_RowCommand" EmptyDataRowStyle-CssClass="alert alert-danger text-center">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton CssClass="btn btn-white btn-bitbucket" ID="lnkBtnDelete" runat="server" OnClientClick="return confirm('Are you sure you want to delete this record.');" CommandName="DeleteLocation" CommandArgument='<%#Eval("OrganizationId") %>'> <i class="fa fa-trash"></i> </asp:LinkButton>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                ...
                                <div class="row text-right">
                                    <div class="col-md-12">
                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                <a class="btn btn-white" onclick="GotoPrevStep(3);" href="#"><%= ResourceMgr.GetMessage("Back")%></a>
                                                <a id="a1" class="btn btn-primary" href="#" style="display: none;"><%= ResourceMgr.GetMessage("Next")%></a>
                                                <cc1:ResourceLinkButton CssClass="btn btn-primary" ID="ResourceLinkButton1" ValidationGroup="Stewardships" runat="server"
                                    ...
                                    <ContentTemplate>
                                        <a class="btn btn-white" onclick="GotoPrevStep(3);" href="#"><%= ResourceMgr.GetMessage("Back")%></a>
                                        <a id="a1" class="btn small next icon i_arrow_right"   href="#" style="display: none;">
                                            <%= ResourceMgr.GetMessage("Next")%></a>
                                        <cc1:ResourceLinkButton ID="ResourceLinkButton1"  CssClass="btn btn-primary" ValidationGroup="Stewardships" runat="server" TextMessage="Next" 
                                            OnClick="lnkBtnStep2_Click"></cc1:ResourceLinkButton>
                                    </ContentTemplate>
                                    <Triggers>
                                        <asp:AsyncPostBackTrigger ControlID="lnkBtnStep2" EventName="Click" />
                                    </Triggers>
                    ...
                    <div id="tab-4" class="tab-pane">
                        ...
                        <div class="mail-box">
                            <div class="mail-body">
                                <div class="row">
                                    <div class="col-md-5" id="dvstCert">
                                    ...
                                    <div class="col-md-5" id="dvTireCert">
                                        <h3><%= ResourceMgr.GetMessage("Transporter Hauling Certifications")%></h3>
                                        <cc1:ResourceCustomValidator ID="CustomValidator2" runat="server" ValidationGroup="Stakeholders"
                                            ClientValidationFunction="ClientValidateCheckBox"
                                            CssClass="custom-block-error" Display="Dynamic" section="dvstCert">
                                            <%= ResourceMgr.GetError("Please select at least one Stakeholder Certification")%>
                                        </cc1:ResourceCustomValidator>
                                        <div class="m-l-sm m-t-md">
                                            <asp:Repeater ID="rptTireCertificates" runat="server">
                                                <ItemTemplate>
                                                    <label class="checkbox m-l-md font-noraml">
                                                        <asp:CheckBox ID="chk" runat="server" />
                                                        <asp:HiddenField ID="hdnID" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "CertificationID") %>' />
                                    ...
                                    <%--         <div id="dvTireCert" class="rsc_left-block" style="padding-right: 35px; padding-left: 35px;">
                                <div class="test" style="width: 270px; height: 40px;">
                                    <%= ResourceMgr.GetMessage("Transporter Hauling Certifications")%>
                                </div>
                                <asp:repeater id="rptTireCertificates" runat="server">
                                    <ItemTemplate>
                                    <div class="rsc-content_block">
                                        <div class="rsc_field" style="width:20px;">
                                            <asp:CheckBox ID="chk" runat="server" />&nbsp;&nbsp;&nbsp;
                                        </div>
                                        <div class="rsc-had"><asp:HiddenField ID="hdnID" runat="server" 
                                            Value='<%# DataBinder.Eval(Container.DataItem, "CertificationID") %>' />
                                            <%#DataBinder.Eval(Container.DataItem, "Name") %>
                                        </div>
                                        <div class="rsc_define">
                                            <%= ResourceMgr.GetMessage("Define")%>
                                        </div>
                                    </div>
                                    </ItemTemplate>
                                </asp:repeater>
                                    ...
                                    <div class="col-md-12">
                                        <asp:UpdatePanel ID="upnlStep2" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                <cc1:ResourceLinkButton CssClass="btn btn-primary" ID="lnkBtnStep2" ValidationGroup="Stakeholders"
                                                    runat="server" OnClick="lnkBtnStep2_Click" OnClientClick="">
                                                    <%= ResourceMgr.GetMessage("Next")%>
                                                </cc1:ResourceLinkButton>
                                            </ContentTemplate>
                                            <Triggers>
                            ...
                            <div id="dvTireCert" class="rsc_left-block" style="padding-right: 35px; padding-left: 35px;">
                                ...
                                <asp:repeater id="rptTireCertificates" runat="server">
                                    ...
                                    <div class="rsc-content_block">
                                        ...
                                        <div class="rsc-had"><asp:HiddenField ID="hdnID" runat="server" Value='<%# DataBinder.Eval(Container.DataItem, "CertificationID") %>' />
                                            <%#DataBinder.Eval(Container.DataItem, "Name") %>
                                        </div>
                                        <div class="rsc_define">
                                            <a href="#"><%= ResourceMgr.GetMessage("Define")%></a>
                                        </div>
                                    </div>
                                    </ItemTemplate>
                                </asp:repeater>
                    ...
                    <div id="tab-5" class="tab-pane">
                        <asp:UpdatePanel ID="upnlSupplierAdd" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
                                ...
                                <div class="mail-box-header">
                                    <div class="pull-right tooltip-demo">
                                        <label class="badge badge-primary pull-right use8steps"><%= ResourceMgr.GetMessage("Step 5 of 7")%></label>
                                        <label class="badge badge-primary pull-right use7steps" style="display: none;"><%= ResourceMgr.GetMessage("Step 4 of 6")%></label>
                                    </div>
                                ...
                                <div class="mail-box">
                                    <div class="mail-body">
                                                    ...
                                                    <asp:UpdatePanel ID="upnlSupplier" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    <asp:TextBox ID="txtSupplierZipCode" runat="server" CssClass="form-control" onblur="HideSupplierZipCodeLabel();" AutoPostBack="true" OnTextChanged="txtSupplierZipCode_TextChanged" CausesValidation="true" ValidationGroup="SupplierZipCode" MaxLength="10">
                                                                    </asp:TextBox>
                                                                    <asp:HiddenField ID="hdnSupplierZipCode" runat="server" Value="" />
                                                                    <br />
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    ...
                                                                    <%-- <cc1:ResourceRequiredFieldValidator ID="RequiredFieldValidator13" runat="server" ControlToValidate="txtSupplierCity" ValidationGroup="SupplierZipCode" ErrorText="Please select City" Display="Dynamic" CssClass="custom-block-error"></cc1:ResourceRequiredFieldValidator>--%>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("State:")%></label>
                                                                <div class="col-sm-7">
                                                                    ...
                                                                    <%-- <cc1:ResourceRequiredFieldValidator ID="ResourceRequiredFieldValidator45" runat="server" ControlToValidate="ddlSuppliersProvince" InitialValueErrorText="0" ValidationGroup="SupplierZipCode" ErrorText="Please select State" Display="Dynamic" CssClass="custom-block-error"></cc1:ResourceRequiredFieldValidator>--%>
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("Country:")%></label>
                                                                <div class="col-sm-7">
                                                                    <asp:DropDownList Enabled="false" ID="ddlSuppliersCountry" runat="server" CssClass="form-control"></asp:DropDownList>
                                                                    <%--  <cc1:ResourceRequiredFieldValidator ID="ResourceRequiredFieldValidator30" runat="server" ControlToValidate="ddlSuppliersCountry" InitialValueErrorText="0" ValidationGroup="SupplierZipCode" ErrorText="Please select Country" Display="Dynamic" CssClass="custom-block-error"></cc1:ResourceRequiredFieldValidator>--%>
                                                                </div>
                                                            </div>
                                                        </ContentTemplate>
                                                        <Triggers>
                                                ...
                                                <div class="form-horizontal">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div class="row">
                                                                <div class="col-md-6">
                                                                    <asp:TextBox ID="txtSupplierscontactFirstName" runat="server" CssClass="form-control" MaxLength="100"
                                                                        placeholder='<%# ResourceMgr.GetError("First Name") %>'></asp:TextBox>
                                                                </div>
                                                                <div class="col-md-6">
                                                                    <asp:TextBox ID="txtSupplierscontactLastName" runat="server" CssClass="form-control" MaxLength="100"
                                                                        placeholder='<%# ResourceMgr.GetError("Last Name") %>'></asp:TextBox>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <asp:TextBox ID="txtSupplierBusinessPhone1" runat="server" CssClass="form-control text-center" MaxLength="3"
                                                                        placeholder="000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <asp:TextBox ID="txtSupplierBusinessPhone2" runat="server" CssClass="form-control text-center" MaxLength="3"
                                                                        placeholder="000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <asp:TextBox ID="txtSupplierBusinessPhone3" runat="server" CssClass="form-control text-center" MaxLength="4"
                                                                        placeholder="0000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <asp:TextBox ID="txtSupplierContactCellPhone1" runat="server" CssClass="form-control text-center"
                                                                        MaxLength="3" placeholder="000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <asp:TextBox ID="txtSupplierContactCellPhone2" runat="server" CssClass="form-control text-center"
                                                                        MaxLength="3" placeholder="000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <asp:TextBox ID="txtSupplierContactCellPhone3" runat="server" CssClass="form-control text-center"
                                                                        MaxLength="4" placeholder="0000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                                </div>
                                                            </div>
                                                            <cc1:ResourceCustomValidator ID="ResourceCustomValidator9" runat="server" ValidationGroup="Step3"
                                                                Display="Dynamic" CssClass="custom-block-error"
                                                            ...
                                                            <cc1:ResourceCustomValidator ID="ResourceCustomValidator21" runat="server" ValidationGroup="Step3"
                                                                Display="Dynamic" CssClass="custom-block-error" ClientValidationFunction="ValidateSupplierBusinessPhoneSameOrNot">
                                                                <%= ResourceMgr.GetError("Please enter different Phone Numbers")%></cc1:ResourceCustomValidator>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="text-right">
                                                    ...
                                                    <div class="custom-block-error" runat="server" visible="false" id="dvsuppliererrormsg">
                                                ...
                                                <div class="table-responsive m-t-md">
                                                    <asp:GridView ID="gvSupplier" runat="server" GridLines="None" ShowHeaderWhenEmpty="true" AutoGenerateColumns="false"
                                                        CssClass="table table-bordered epr-sec-table" CellPadding="0" CellSpacing="0" BorderWidth="0" Width="100%" wrap="nowrap" EmptyDataRowStyle-CssClass="alert alert-danger text-center" OnRowCommand="gvSupplier_RowCommand">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <cc1:ResourceLinkButton CssClass="btn btn-white btn-bitbucket" ID="lnkbuttonedit" runat="server" CommandName="EditSupplier"
                                                                        CommandArgument='<%#Eval("SupplierId") %>'>
                                                                <i class="fa fa-edit"></i>
                                                                    </cc1:ResourceLinkButton>

                                                                    <cc1:ResourceLinkButton CssClass="btn btn-white btn-bitbucket" ID="lnkBtnDelete" runat="server"
                                                                        OnClientClick="return confirm('Are you sure you want to delete this record.');"
                                                                        CommandName="DeleteSupplier" CommandArgument='<%#Eval("SupplierId") %>'>
                                                                <i class="fa fa-trash"></i></cc1:ResourceLinkButton>
                                                                </ItemTemplate>
                                                            </asp:TemplateField>
                                                        </Columns>
                                                        <EmptyDataTemplate><%= ResourceMgr.GetMessage("No Record Exists")%></EmptyDataTemplate>
                                        ...
                                        <div class="row text-right">
                                            <div class="col-md-12">
                                                <a onclick="GotoPrevStep(5);" class="btn btn-white" href="#"><%= ResourceMgr.GetMessage("Back")%></a>
                                                <a onclick="GotoNextStep(5,'Step3');" class="btn btn-primary" href="#"><%= ResourceMgr.GetMessage("Next")%></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div id="tab-6" class="tab-pane ">
                        <div class="mail-box-header">
                            <div class="pull-right tooltip-demo">
                                <label class="badge badge-primary pull-right use8steps"><%= ResourceMgr.GetMessage("Step 6 of 7")%></label>
                                <label class="badge badge-primary pull-right use7steps" style="display: none;"><%= ResourceMgr.GetMessage("Step 5 of 6")%></label>
                            </div>
                        ...
                        <div class="mail-box">
                            <div class="mail-body">
                                                ...
                                                <ContentTemplate>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            ...
                                                            <cc1:ResourceRequiredFieldValidator ID="ResourceRequiredFieldValidator34" runat="server" ControlToValidate="txtClientZipCode"
                                                            ...
                                                            <cc1:ResourceRegularExpressionValidator ID="ResourceRegularExpressionValidator10" runat="server" ControlToValidate="txtClientZipCode"
                                                                ValidationGroup="ClientZipCode" Display="Dynamic"
                                                                CssClass="custom-block-error" ValidationExpression="^\d{5}$|^([a-zA-Z]\d[a-zA-Z]( )\d[a-zA-Z]\d)$">
                                                                <%= ResourceMgr.GetError("Please enter valid ZIP Code e.g; 06514, M3C 0C1") %>
                                                            </cc1:ResourceRegularExpressionValidator>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("City:")%></label>
                                                        <div class="col-sm-7">
                                                            <asp:TextBox ID="txtClientCity" Enabled="false" runat="server" CssClass="form-control" MaxLength="100"></asp:TextBox>
                                                            <%-- <cc1:ResourceRequiredFieldValidator ID="ResourceRequiredFieldValidator36" runat="server" ControlToValidate="txtClientCity" ValidationGroup="ClientZipCode" ErrorText="Please enter City" Display="Dynamic" CssClass="custom-block-error"></cc1:ResourceRequiredFieldValidator>--%>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("State:")%></label>
                                                        <div class="col-sm-7">
                                                            <asp:DropDownList ID="ddlclientsProvince" Enabled="false" runat="server" CssClass="form-control"></asp:DropDownList>
                                                            <%-- <cc1:ResourceRequiredFieldValidator ID="ResourceRequiredFieldValidator46" runat="server" ControlToValidate="ddlclientsProvince" ValidationGroup="ClientZipCode" InitialValueErrorText="0" ErrorText="Please select State" Display="Dynamic" CssClass="custom-block-error"></cc1:ResourceRequiredFieldValidator>--%>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("Country:")%></label>
                                                        <div class="col-sm-7">
                                                            <asp:DropDownList Enabled="false" ID="ddlclientsCountry" runat="server" CssClass="form-control"></asp:DropDownList><br />

                                                            <%-- <cc1:ResourceRequiredFieldValidator ID="ResourceRequiredFieldValidator47" runat="server" ControlToValidate="ddlclientsCountry" ValidationGroup="ClientZipCode" InitialValueErrorText="0" ErrorText="Please select Country" Display="Dynamic" CssClass="custom-block-error"></cc1:ResourceRequiredFieldValidator>--%>
                                                        </div>
                                                    </div>
                                                </ContentTemplate>
                                                <Triggers>
                                        ...
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <asp:TextBox ID="txtclientsContactFirstName" runat="server" CssClass="form-control" MaxLength="100"
                                                                placeholder='<%# ResourceMgr.GetError("First Name") %>'></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <asp:TextBox ID="txtclientsContactLastName" runat="server" CssClass="form-control" MaxLength="100"
                                                                placeholder='<%# ResourceMgr.GetError("Last Name") %>'></asp:TextBox>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <asp:TextBox ID="txtClientBusinessPhone1" runat="server" CssClass="form-control text-center" MaxLength="3"
                                                                placeholder="000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <asp:TextBox ID="txtClientBusinessPhone2" runat="server" CssClass="form-control text-center" MaxLength="3"
                                                                placeholder="000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <asp:TextBox ID="txtClientBusinessPhone3" runat="server" CssClass="form-control text-center" MaxLength="4"
                                                                placeholder="0000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <cc1:ResourceCustomValidator ID="vldcusClientBusinessPhone" runat="server" ValidationGroup="Step4"
                                                        Display="Dynamic" CssClass="custom-block-error"
                                                        ClientValidationFunction="ValidateClientBusinessPhone">
                                                        <%= ResourceMgr.GetError("Please enter Business Phone") %>
                                                    </cc1:ResourceCustomValidator>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="row">
                                                        <div class="col-md-4">
                                                            <asp:TextBox ID="txtClientCellPhone1" runat="server" CssClass="form-control text-center" MaxLength="3"
                                                                placeholder="000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <asp:TextBox ID="txtClientCellPhone2" runat="server" CssClass="form-control text-center" MaxLength="3"
                                                                placeholder="000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-4">
                                                            <asp:TextBox ID="txtClientCellPhone3" runat="server" CssClass="form-control text-center" MaxLength="4"
                                                                placeholder="0000" onkeypress="return isNumberKey(event);"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                    <cc1:ResourceCustomValidator ID="ResourceCustomValidator11" runat="server" ValidationGroup="Step4"
                                                        Display="Dynamic" CssClass="custom-block-error"
                                                        ClientValidationFunction="ValidateClientCellPhone">
                                                        <%= ResourceMgr.GetError("Please enter Primary Contact Cell Phone") %>
                                                    </cc1:ResourceCustomValidator>

                                                    <cc1:ResourceCustomValidator ID="ResourceCustomValidator22" runat="server" ValidationGroup="Step4"
                                                        Display="Dynamic" CssClass="custom-block-error"
                                                        ClientValidationFunction="ValidateClientBusinessPhoneSameOrNot">
                                                        <%= ResourceMgr.GetError("Please enter different Phone Numbers")%>
                                                    </cc1:ResourceCustomValidator>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-7">
                                                    ...
                                                    <cc1:ResourceRequiredFieldValidator ID="ResourceRequiredFieldValidator38" runat="server"
                                                        ControlToValidate="txtclientsEmail" ValidationGroup="Step4"
                                                        Display="Dynamic" CssClass="custom-block-error"><%= ResourceMgr.GetError("Please enter Primary Contact Email")%></cc1:ResourceRequiredFieldValidator>
                                                    <cc1:ResourceRegularExpressionValidator ID="ResourceRegularExpressionValidator12"
                                                        runat="server" ControlToValidate="txtclientsEmail"
                                                        ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ValidationGroup="Step4"
                                                        CssClass="custom-block-error" Display="Dynamic"><%= ResourceMgr.GetError("Please enter valid Email Address")%></cc1:ResourceRegularExpressionValidator>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <asp:UpdatePanel ID="upnlClientAdd" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="text-right">
                                                    <cc1:ResourceLinkButton CssClass="btn btn-sm btn-primary" ID="lnkAddClient" runat="server" CausesValidation="true"
                                                        ValidationGroup="Step4" OnClick="lnkAddClient_Click"><%=ResourceMgr.GetMessage("Add Supplier") %></cc1:ResourceLinkButton>
                                                    <asp:HiddenField ID="hdnClientCount" runat="server" Value="0" />
                                                </div>
                                                <div class="table-responsive m-t-md">
                                                    <asp:GridView ID="gvClient" runat="server" GridLines="None" ShowHeaderWhenEmpty="true" AutoGenerateColumns="false"
                                                        CssClass="table table-bordered epr-sec-table" CellPadding="0" CellSpacing="0" BorderWidth="0" Width="100%" wrap="nowrap" OnRowCommand="gvClient_RowCommand" EmptyDataRowStyle-CssClass="alert alert-danger text-center">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Actions" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <asp:LinkButton CssClass="btn btn-white btn-bitbucket" ID="lnkBtnDelete" runat="server" OnClientClick="return confirm('Are you sure you want to delete this record.');" CommandName="DeleteClient" CommandArgument='<%#Eval("ClientId") %>'>
                                ...
                                <div class="row text-right">
                                    <div class="col-md-12">
                                        <a class="btn btn-primary" onclick="GotoPrevStep(6);" href="#"><%= ResourceMgr.GetMessage("Back")%></a>
                                        <a class="btn btn-white" onclick="GotoNextStep(6,'Step4');" href="#"><%= ResourceMgr.GetMessage("Next") %></a>
                                    </div>
                    ...
                    <div id="tab-7" class="tab-pane">
                        <div class="mail-box-header">
                            <div class="pull-right tooltip-demo">
                                ...
                                <label class="badge badge-primary pull-right use4steps" style="display: none;"><%= ResourceMgr.GetMessage("Step 3 of 3")%></label>
                                <label class="badge badge-primary pull-right use3steps" style="display: none;"><%= ResourceMgr.GetMessage("Step 2 of 2")%></label>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <cc1:ResourceCustomValidator ID="CustomValidator4" runat="server" ValidationGroup="SubmitApplication"
                                            ...
                                            CssClass="custom-block-error" Display="Dynamic" Field="chkotsPrivacy"><%= ResourceMgr.GetError("Please select Steward Privacy Agreement")%></cc1:ResourceCustomValidator>
                                        <label class="checkbox m-l-md">
                                        ...
                                        <cc1:ResourceCustomValidator ID="CustomValidator5" runat="server" ValidationGroup="SubmitApplication"
                                            ClientValidationFunction="ClientValidateStep6" CssClass="custom-block-error" Display="Dynamic"
                                            Field="chktiretraxPrivacy"><%= ResourceMgr.GetError("Please select EPRTS Privacy Agreement")%></cc1:ResourceCustomValidator>
                                    </div>
                                </div>
                                <div class="row text-right">
                                    <div class="col-md-12">
