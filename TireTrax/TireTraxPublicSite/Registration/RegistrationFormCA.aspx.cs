...
public partial class Registration_RegistrationFormCA : BasePage
{
    private int _GlobalCountryID = 39; // Canada CountryId
    ...
    {
        DataSet ds = Agreement.getAgreement(Convert.ToInt16(AgreementTypes.CA_ENStewardshipPrivacyAgreement));
        ltrlstewardshipPrivacyAgreement.Text = ds.Tables[0].Rows[0]["vchAgreementText"].ToString();
        ds = Agreement.getAgreement(Convert.ToInt16(AgreementTypes.CA_ENTireTraxPrivacyAgreement));
    ...
    public void LoadHeaderTextForAddLocations()
    {
        ...
        gvAdditionLocations.HeaderRow.Cells[5].Text = ResourceMgr.GetMessage("Postal Code");
    ...
    private void LoadDropDown()
    {
        ...
        Utils.GetLookUpData<DropDownList>(ref ddlOrganizationSubType, LookUps.OrganizationSubType, 1);

        if (Convert.ToInt32(Request.QueryString["SSID"]) > 0 && ddlOrganizationType.Items.FindByValue("127") != null
        && OrganizationInfo.getStewardshipStatusByStateId(Convert.ToInt32(Request.QueryString["SSID"])) > 0)
        {
            ddlOrganizationType.Items.Remove(ddlOrganizationType.Items.FindByValue("127"));
        }
        else if (/*Convert.ToInt32(Request.QueryString["SSID"]) == 0 &&*/ ddlOrganizationType.Items.FindByValue("127") != null
            && OrganizationInfo.getStewardshipStatusByStateId(Convert.ToInt32(Request.QueryString["SSID"])) == 0)
        {
            ddlOrganizationType.SelectedValue = "127";
    ...
    protected void lnkbtnStep1_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            {
                //ToolkitScriptManager.RegisterStartupScript(this, this.GetType(), "Step2", String.Format("GotoNextStep();SetHiddenFieldValue('{0}','{1}');", hdnOrganizationID.ClientID, objOrg.OrganizationId), true);
            }
    ...
    protected void submit_Click(object sender, EventArgs e)
    {
        ...
        //    RoleId = Convert.ToInt32(UserInfo.UserRole.Stewardship);
        //}
        //int RoleId = Conversion.ParseInt(ddlOrganizationType.SelectedValue);
    ...
    private void SendEmails(Emails email, string type)
    {
        ...
        {
            new SqlLog().InsertSqlLog(0, "RegistrationFormCA SendEmails", ex);
        }
