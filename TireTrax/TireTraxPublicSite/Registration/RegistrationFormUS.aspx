<%@ Page Title="" Language="C#" MasterPageFile="~/skeleton.Master" AutoEventWireup="true"
    CodeFile="RegistrationFormUS.aspx.cs" Inherits="Registration_RegistrationFormUS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function SetHiddenFieldValue(hdn, val) {
            $("#" + hdn).val(val);
            //             $("#<%=txtBusinessAddress1.ClientID%>").click();
        ...
        $(function () {
            ApplyWaterMarkOnTextBoxes(); SetFocusOnStep1(); ShowDateRange(false);
        });
        ...
        function SetCertifiedInspector(ddl) {
        ...
        function DisableInspectorTab() {
            $("#li5").css('display', 'none');
            $("#li6").css('display', 'none');
            $(".use5steps").show();
            $(".use5steps").show();
            $(".use7steps").hide();
            GotoNextStep(4, 'Stakeholders');
        }

        function EnableInspectorTab() {
            $("#li5").css('display', '');
            $("#li6").css('display', '');
            $(".use5steps").hide();
            $(".use5steps").hide();
        ...
        function GotoNextStep(liId, validationGroup) {
            ...
            if (liId == 1) {
                if ($('#<%=lblemailalreadyexists.ClientID%>').length > 0) {
                return;
            }
        ...
        if (liId == 5) {
            if (Page_ClientValidate(validationGroup) && Page_ClientValidate("WholeStep3")) {//&& Page_ClientValidate("SupplierZipCode")
                var start = liId + 1;
                    <%--debugger;
                    var rowscount = document.getElementByID('<%=gvSupplier.ClientID%>').rows.length;
                    alert(rowscount);--%>
            ...
            <div class="wrapper wrapper-content animated fadeInRight reg">
                    ...
                    <div class="panel-options">
                        <ul class="nav nav-tabs" data-connect="breadcrumbcontent ">
                            ...
                            <%-- <li></li>
                                    ...
                                    <li id="li5"></li>
                                    <li id="li6"></li>
                                    <li><a href="#" validationgroup="LoginInfo">
                <%= ResourceMgr.GetMessage("Login Registration")%></a></li>
                                    <li></li>--%>
                        </ul>
                    </div>
                </div>
                ...
                <div id="breadcrumbcontent" class="tab-content">
                                ...
                                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                                ...
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            ...
                                                            <asp:Label ID="lblemailalreadyexists" runat="server" CssClass="custom-block-error" Visible="false">
                                                                <%= ResourceMgr.GetError("Email already exists for this state. Choose another") %>
                                                            </asp:Label>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                ...
                                                <div class="form-horizontal">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            ...
                                                            <asp:Label ID="lblStewardshipExists" runat="server" CssClass="error_message" Text="Stewardship already exists for this state." Visible="false"></asp:Label>
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <asp:UpdatePanel ID="upnlBillingContact" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-sm-7">
                                                                    <asp:TextBox ID="txtMailingZipCode" runat="server" CssClass="form-control" onblur="HideMailingZipCodeLabel();" AutoPostBack="true"
                                                                        OnTextChanged="txtMailingZipCode_TextChanged" CausesValidation="true" ValidationGroup="MailingZipCode"></asp:TextBox>
                                                                    <asp:HiddenField ID="hdnMailingZipCodeId" runat="server" Value="" />
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("City:")%></label>
                                                                <div class="col-sm-7">
                                                                    <asp:TextBox ID="txtMailingCity" Enabled="false" runat="server" CssClass="form-control" MaxLength="100"></asp:TextBox>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("State:")%></label>
                                                                <div class="col-sm-7">
                                                                    <asp:DropDownList ID="ddlMailingState" Enabled="false" runat="server" CssClass="form-control"></asp:DropDownList>
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("Auto-Fund Transfers:")%></label>
                                                        <div class="col-sm-7">
                                                            <label class="checkbox">
                                        ...
                                        <div class="row text-right">
                                            <div class="col-md-12">
                                                <a id="aStep1" class="btn btn-primary" href="#" style="display: none;"></a>
                                        ...
                                        <div class="form-horizontal">
                                            ...
                                            <div class="form-group" id="dvDateRange">
                                                ...
                                                <div class="col-sm-7">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <asp:TextBox ID="txtLocationFromDate" runat="server" CssClass="form-control" placeholder='<%# ResourceMgr.GetError("From") %>'></asp:TextBox>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <asp:TextBox ID="txtLocationToDate" runat="server" CssClass="form-control" placeholder='<%# ResourceMgr.GetError("To")%>'></asp:TextBox>
                                                        </div>
                                                    </div>
                    ...
                    <div id="tab-3" class="tab-pane">
                            ...
                            <div class="mail-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-3 col-md-offset-1">
                                        ...
                                        <div id="dvCertSTrax" class="sub_block_outer">
                                            <label class="checkbox m-l-md">
                                    ...
                                    <div class="col-md-12">
                                        <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                <cc1:ResourceLinkButton CssClass="btn btn-primary" ID="lnkBtnStepStewardship" ValidationGroup="Stewardships"
                                                    runat="server" OnClick="lnkBtnStepStewardship_Click"><%= ResourceMgr.GetMessage("Next")%></cc1:ResourceLinkButton>
                                            </ContentTemplate>
                                            <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="lnkBtnStepStewardship" EventName="Click" />
                                            </Triggers>
                                        </asp:UpdatePanel>
                                    </div>
                                </div>
                        ...
                        <div class="first-tab-content" style="padding-bottom: 0px;">
                            <div class="cmp_info_form">
                                <%--May be script on these classes--%>
                                <div class="title_block" style="height: 40px;">
                                    <div class="forgot_pass">
                                        <div class="use8steps">
                                        </div>
                                        <div class="use4steps" style="display: none;">
                                        </div>
                                    </div>
                                    <div style="color: Green; font: 12px/2 arial; clear: both; color: #F00; text-align: justify; padding-left: 11px;">
                                        <%--  <%= ResourceMgr.GetMessage("Please check-mark at lease one choice.")%>--%>
                                    </div>
                                </div>

                            </div>

                            <div class="certify_outer2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-md-offset-1">
                                        ...
                                        <div class="m-l-sm m-t-md">
                                            ...
                                            <label class="checkbox m-l-md font-noraml">
                                                <asp:CheckBox ID="chkImportExportNationally" runat="server" />
                                                <%= ResourceMgr.GetMessage("Nationally")%>
                                                <span class="label pull-right clearfix"><%= ResourceMgr.GetMessage("Define")%></span>
                                            </label>
                                            <label class="checkbox m-l-md font-noraml">
                                    ...
                                    <div class="col-md-12">
                                        <asp:UpdatePanel ID="upnlStep2" runat="server" UpdateMode="Conditional">
                                            <ContentTemplate>
                                                ...
                                                <cc1:ResourceLinkButton CssClass="btn btn-primary" ID="lnkBtnStep2" ValidationGroup="Stakeholders" runat="server"
                                                    OnClick="lnkBtnStep2_Click" OnClientClick=""><%= ResourceMgr.GetMessage("Next")%></cc1:ResourceLinkButton>
                                            </ContentTemplate>
                                            <Triggers>
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-horizontal">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <asp:HiddenField runat="server" ID="hdnClearSupplierInfo" />
                                                    ...
                                                    <asp:UpdatePanel ID="upnlSupplier" runat="server" UpdateMode="Conditional">
                                                        <ContentTemplate>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("State:")%></label>
                                                                <div class="col-sm-7">
                                                                    <asp:DropDownList Enabled="false" ID="ddlSuppliersProvince" runat="server" CssClass="form-control" AppendDataBoundItems="false"></asp:DropDownList>
                                                            ...
                                                            <div class="form-group">
                                                                <label class="col-sm-5 control-label"><%= ResourceMgr.GetMessage("Country:")%></label>
                                                                <div class="col-sm-7">
                                                                    <asp:DropDownList Enabled="false" ID="ddlSuppliersCountry" runat="server" CssClass="form-control" AppendDataBoundItems="false"></asp:DropDownList>
                                                ...
                                                <div class="table-responsive m-t-md">
                                                    <asp:GridView ID="gvSupplier" runat="server" GridLines="None" ShowHeaderWhenEmpty="true" AutoGenerateColumns="false"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Delete" ItemStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center">
                                                                <ItemTemplate>
                                                                    <cc1:ResourceLinkButton CssClass="btn btn-white btn-bitbucket" ID="lnkbuttonedit" runat="server"
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="table-responsive m-t-md">
                                                    <asp:GridView ID="gvClient" runat="server" GridLines="None" ShowHeaderWhenEmpty="true" AutoGenerateColumns="false"
                                                        CssClass="table table-bordered epr-sec-table" CellPadding="0" CellSpacing="0" BorderWidth="0" Width="100%" wrap="nowrap"
                                                        OnRowCommand="gvClient_RowCommand" EmptyDataRowStyle-CssClass="alert alert-danger text-center">
                                                        <Columns>
                                ...
                                <div class="row text-right">
                                    <div class="col-md-12">
                                        ...
                                        <asp:UpdatePanel ID="upnSubmit" runat="server" UpdateMode="Conditional" style="display: inline-block">
                                            <ContentTemplate>
                                                <cc1:ResourceLinkButton ID="submit" runat="server" CssClass="btn btn-primary" OnClick="submit_Click" CausesValidation="true"
                                                    OnClientClick="Page_ClientValidate('Step6');" ValidationGroup="SubmitApplication"><%= ResourceMgr.GetMessage("Submit")%></cc1:ResourceLinkButton>
                                            </ContentTemplate>
                                            <Triggers>
