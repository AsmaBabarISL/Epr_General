...
public partial class Registration_RegistrationFormMX : BasePage
{
    public int _GlobalCountryID = 159; // Mexico CountryId
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            //txtLocationFromDate.Enabled = false;
    ...
    private void LoadDropDown()
    {
        ...
        if (Convert.ToInt32(Request.QueryString["SSID"]) > 0 && ddlOrganizationType.Items.FindByValue("115") != null
            && OrganizationInfo.getStewardshipStatusByStateId(Convert.ToInt32(Request.QueryString["SSID"])) > 0)
        {
            ddlOrganizationType.Items.Remove(ddlOrganizationType.Items.FindByValue("115"));
        }
        else if (Convert.ToInt32(Request.QueryString["SSID"]) > 0 && ddlOrganizationType.Items.FindByValue("115") != null
             && OrganizationInfo.getStewardshipStatusByStateId(Convert.ToInt32(Request.QueryString["SSID"])) == 0)
        {
            ddlOrganizationType.SelectedValue = "115";
            ddlOrganizationType.Enabled = false;
            ClientScript.RegisterStartupScript(GetType(), "SetWizard", "SetWizard(document.getElementById('ddlOrganizationType'));", true);
        }
        ...
        ////////////////////////////// Added by Muhammad Bashir to fix the issue with empty dropdown of organizationsubtype/////////////
    ...
    protected void lnkbtnStep1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            for (int i = 0; i < arr.Count(); i++)
            {
                ...
                {
                    if (OrganizationInfo.CheckStateAvailableForStewarship(Convert.ToInt32(ddlBusinessProvince.SelectedValue)) > 0)
                    {
            ...
            {
                ScriptManager.RegisterStartupScript(this, this.GetType(), "Step2", String.Format("GotoNextStep(1, 'PrimaryRegistartion');SetHiddenFieldValue('{0}','{1}');", hdnOrganizationID.ClientID, objOrg.OrganizationId), true);
            }
    ...
    protected void lnkBtnLocationAdd_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ScriptManager.RegisterStartupScript(this, this.GetType(), "ClearAdditionalLocationFields", "ClearAdditionalLocationFields();", true);
    ...
    protected void lnkAddSupplier_Click(object sender, EventArgs e)
    {
        ...
        ScriptManager.RegisterStartupScript(this, this.GetType(), "ClearSupplierFields", String.Format("ClearSupplierFields();SetHiddenFieldValue('{0}','{1}');", hdnSupplierCount.ClientID, gvSupplier.Rows.Count), true);
    ...
    protected void lnkAddClient_Click(object sender, EventArgs e)
    {
        ...
        ScriptManager.RegisterStartupScript(this, this.GetType(), "ClearClientFields", String.Format("ClearClientFields();SetHiddenFieldValue('{0}','{1}');", hdnClientCount.ClientID, gvClient.Rows.Count), true);
    ...
    private void SendEmails(Emails email, string type)
    {
        ...
        {
            new SqlLog().InsertSqlLog(0, "RegistrationFormMX SendEmails", ex);
        }
    ...
    //    {
    //        ScriptManager.RegisterStartupScript(this, this.GetType(), "Step6", "GotoNextStep();", true);
    //        return;
    //    }
    ...
    //    else
    //    {
    //        ScriptManager.RegisterStartupScript(this, this.GetType(), "ShowLoginExistsError", "ShowLoginExistsError();", true);
    //    }
    ...
    protected void txtBusinessZipCode_TextChanged(object sender, EventArgs e)
    {
        ...
        else
        {
            ...
            lblBusinessZipCode.Text = ResourceMgr.GetError("* Zipcode does not exist in this state.");
        }
    }
    ...
    protected void gvSupplier_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        ScriptManager.RegisterStartupScript(this, this.GetType(), "SetHiddenFieldValue", String.Format("SetHiddenFieldValue('{0}','{1}');", hdnSupplierCount.Value, gvSupplier.Rows.Count), true);
    }
    ...
    protected void gvClient_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        ScriptManager.RegisterStartupScript(this, this.GetType(), "SetHiddenFieldValue", String.Format("SetHiddenFieldValue('{0}','{1}');", hdnClientCount.ClientID, gvClient.Rows.Count), true);
    }
    ...
    protected void btnGoToHome(object sender, EventArgs e)
    {
