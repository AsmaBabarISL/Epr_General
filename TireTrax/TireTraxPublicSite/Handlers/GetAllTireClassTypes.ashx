<%@ WebHandler Language="C#" Class="GetAllTireClassTypes" %>
...
public class GetAllTireClassTypes : IHttpHandler {
    ...
    private void showAllTireClassTypes(HttpContext context)
    {

        DataSet ds = Tire.getAllTireClassTypes();
