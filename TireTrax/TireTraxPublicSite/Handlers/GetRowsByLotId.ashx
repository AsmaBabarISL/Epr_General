<%@ WebHandler Language="C#" Class="GetRowsByLotId" %>
...
public class GetRowsByLotId : IHttpHandler {

    public static string LotId, outputType;
    public void ProcessRequest (HttpContext context) {
        context.Response.ContentType = "text/xml";
        LotId = outputType= string.Empty;
    ...
    private void getLotRowsByLotId(HttpContext context)
    {
        DataSet ds = null;
        if (context.Request["LotId"] != null)
        {
            ds = LotRows.getLotRowsByLotId(Conversion.ParseInt(LotId));
