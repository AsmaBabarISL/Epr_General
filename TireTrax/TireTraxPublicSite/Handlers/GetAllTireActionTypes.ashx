<%@ WebHandler Language="C#" Class="GetAllTireActionTypes" %>
...
public class GetAllTireActionTypes : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        showAllTireActionTypes(context);
    }
    ...
    private void showAllTireActionTypes(HttpContext context)
    {

        DataSet ds = Tire.getAllTireActionTypes();
