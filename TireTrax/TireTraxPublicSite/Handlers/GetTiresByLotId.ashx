<%@ WebHandler Language="C#" Class="GetTyresByLotId" %>
...
public class GetTyresByLotId : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        {
            context.Response.Write("<TireTrax><ErrorCode>601</ErrorCode><Message> Please provide LotId</Message></TireTrax>");
            return;
        }
        ...
        System.Data.DataSet ds = Tire.getCompleteTireInfo_ByLotID(Conversion.ParseInt(lotid));
