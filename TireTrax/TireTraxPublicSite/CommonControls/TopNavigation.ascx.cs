...
public partial class CommonControls_topnavigation : BaseControl
{
...
//        litLoginName.Text = obj.Login;
        litLoginName.Text = obj.FullName;
        ...
        if (!IsPostBack)
        {
            ...
            try
            {
                ...
                lblDetail.Text = ds1.Tables[0].Rows[0]["StateName"].ToString() + " " + CatName + " " + userinfoobj.RoleName;
            }
            catch { }
