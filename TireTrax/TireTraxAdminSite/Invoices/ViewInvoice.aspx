<%@ Page Title="" Language="C#" MasterPageFile="~/adminMaster.master" AutoEventWireup="true" CodeFile="ViewInvoice.aspx.cs" Inherits="Invoices_ViewInvoice" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel runat="server" ID="upnlUpdate">
        <ContentTemplate>
                                    ...
                                    <div class="input-daterange">
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <asp:TextBox ID="txtFrmDate" runat="server" CssClass="form-control classTarget"></asp:TextBox>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-3">
                                            <label>To</label>
                        ...
                        <div class="col-sm-12">
                            <div class="table-responsive">
                                <asp:GridView ID="gvInvoicesinfo" AutoGenerateColumns="False" EmptyDataRowStyle-CssClass="alert alert-danger text-center"
                                    ...
                                    runat="server" OnRowCommand="gvInvoicesinfo_RowCommand">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:Label ID="lnkApproved" runat="server"
                                                    ToolTip="Invoice paid" CssClass="badge badge-primary"
                                                    Visible='<%#Convert.ToBoolean(Eval("IsPaid"))%>'>Invoice paid</asp:Label>

                                                <asp:Label ID="lnkRejected" runat="server"
                                                    ToolTip="Invoice not yet paid " CssClass="badge badge-danger"
                                        ...
                                        <asp:TemplateField HeaderText="">
                                            ...
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="ImgbtnInvoiceID" runat="server" ToolTip="View Invoice" CssClass="btn btn-white btn-bitbucket"
                                                    CommandArgument='<%# Eval("InvoiceID") %>' CommandName="InvoiceInfo">
                                            <i class="fa fa-eye"></i></asp:LinkButton>
                                                <asp:LinkButton ID="lnkbtnPaymentDetail" runat="server" ToolTip="View Payment Detail" CssClass="btn btn-white btn-bitbucket"
                                                    CommandArgument='<%# Eval("InvoiceID") %>' Visible='<%#(bool) Eval("IsPaid") == true ? true : false %>'
                                                    CommandName="PaymentDetail">
                                        <i class="fa fa-eye"></i></asp:LinkButton>
                                                <asp:LinkButton ID="lnkbtnPay" runat="server" CssClass="btn btn-white btn-bitbucket"
                                                    ToolTip="Send Invoice" Visible='<%#(bool) Eval("IsPaid") == true ? false : true %>'
                                                    CommandName="Pay" CommandArgument='<%# Bind("InvoiceID")%>'>
            ...
            <div class="ajaxModal-popup inmodal" id="dvInvoicepopup" runat="server" visible="false">
                <div class="ajaxModal-body animated bounceInRight">
                    ...
                    <div class="modal-body">
                        ...
                        <div role="form" class="row search-filter" runat="server" id="dvInvoiceInfo">
                            <div class="form-group col-md-6">
                                <label style="font-weight: bold;"><%= ResourceMgr.GetMessage("To:")%></label>
                                <asp:Label ID="lblTo" runat="server"></asp:Label>
                                <asp:Label ID="lblOrganizationId" runat="server" Visible="false"></asp:Label>
                            </div>
                            <div class="form-group col-md-6">
                                <label style="font-weight: bold;"><%= ResourceMgr.GetMessage("From:")%></label>
                                <asp:Label ID="lblFrom" runat="server"></asp:Label>
                            </div>
                            <div class="form-group col-md-6">
                                <label style="font-weight: bold;"><%= ResourceMgr.GetMessage("Invoice ID:")%></label>
                                <asp:Label ID="lblInvoiceID" runat="server"></asp:Label>
                            </div>

                            <div class="form-group col-md-6">
                                <label style="font-weight: bold;"><%= ResourceMgr.GetMessage("Invoice Date:")%></label>
                                <asp:Label ID="lblinvoiceDate" runat="server"></asp:Label>
                            </div>
                            <div class="form-group col-md-6">
                                <label style="font-weight: bold;"><%= ResourceMgr.GetMessage("Invoice Amount:")%></label>
                                <asp:Label ID="lblInvoiceAmount" runat="server"></asp:Label>
                            </div>

                            <div class="form-group col-md-6">
                                <label style="font-weight: bold;"><%= ResourceMgr.GetMessage("Due Date:")%></label>
                                    ...
                                    <asp:GridView ID="gvInvoicesDetails" AutoGenerateColumns="False" EmptyDataRowStyle-CssClass="alert alert-danger"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="">
                                                ...
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAmt" runat="server" Text='<%# Eval("PTEamount","{0:c}")%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                    ...
                    <div class="modal-footer">
                        ...
                        <cc1:ResourceLinkButton class="btn btn-white btn-sm" ID="ResourceLinkButton2" runat="server"
                            OnClick="btnInvoiceDetailBack_Click"><%= ResourceMgr.GetMessage("Back") %></cc1:ResourceLinkButton>
                        <cc1:ResourceLinkButton runat="server" CssClass="btn btn-primary btn-sm" ID="btnPrintInvoice" OnClick="btnPrintInvoice_Click" ToolTip="Export as Pdf or Excel or Word">
                                    <%= ResourceMgr.GetMessage("Export") %>
            ...
            <div class="ajaxModal-popup inmodal" id="dvInvoicePaymentPopup" runat="server" visible="false">
                <div class="ajaxModal-body animated bounceInRight">
                    ...
                    <div class="modal-body">
                        ...
                        <div role="form" class="row search-filter" id="">
                            <div class="form-group col-md-6">
                                <asp:Label ID="Label1" runat="server" Style="font-weight: bold;"><%= ResourceMgr.GetMessage("Invoice ID:")%></asp:Label>
                                <asp:Label ID="lblInvoicePaymentId" runat="server"></asp:Label>
                                <asp:HiddenField runat="server" ID="hdnInvoiceId" />
                            </div>
                            <div class="form-group col-md-6">
                                <asp:Label ID="Label8" runat="server" Style="font-weight: bold;"><%= ResourceMgr.GetMessage("Due Date")%></asp:Label>
                                <asp:Label ID="lblInvoicePaymentDueDate" runat="server"></asp:Label>
                            </div>

                            <div class="form-group col-md-6">
                                <asp:Label ID="Label10" runat="server" Style="font-weight: bold;"><%= ResourceMgr.GetMessage("Invoice Date:")%></asp:Label>
                                <asp:Label ID="lblInvoicePaymentDate" runat="server"></asp:Label>
                            </div>
                            <div class="form-group col-md-6">
                                <asp:Label ID="Label12" runat="server" Style="font-weight: bold;"><%= ResourceMgr.GetMessage("Invoice Amount:")%></asp:Label>
                            ...
                            <div class="form-group col-md-6">
                                <asp:Label ID="Label14" runat="server" Style="font-weight: bold;"><%= ResourceMgr.GetMessage("Balance Amount:")%></asp:Label>
                        ...
                        <div class="row">
                            <div class="form-group col-md-4">
                                <label>
                                    <%=ResourceMgr.GetMessage("Payment Mode") %>
                                </label>
                                <asp:DropDownList runat="server" ID="ddlPaymentMode" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="ddlPaymentMode_SelectedIndexChanged" EnableViewState="true">
                                </asp:DropDownList>
                            </div>
                        </div>
                        ...
                        <div class="row" id="dvPaymentModeCheck" runat="server" visible="false">
                        ...
                        <cc1:ResourceRequiredFieldValidator runat="server" ID="ResourceRequiredFieldValidator6" ControlToValidate="txtAccountNumber" ErrorMessage="Please Enter Amount" CssClass="custom-error" Valida tionGroup="Check"></cc1:ResourceRequiredFieldValidator>--%>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <%--<asp:TextBox runat="server" ID="txtBranchCode" CssClass="form-control"></asp:TextBox>--%>
                                </div>
                        ...
                        <cc1:ResourceRequiredFieldValidator runat="server" ID="ResourceRequiredFieldValidator6" ControlToValidate="txtAccountNumber" ErrorMessage="Please Enter Amount" CssClass="custom-error" Valida tionGroup="Check"></cc1:ResourceRequiredFieldValidator>--%>
                            ...
                            <div class="row col-md-12">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <asp:TextBox runat="server" ID="txtPaymentAmount" CssClass="form-control" onkeypress="return ValidateNumberic(event);" MaxLength="6"></asp:TextBox>
                        ...
                        <div class="row" id="dvCreditCard" runat="server" visible="false">
                            <div role="form" class="row row search-filter col-md-12">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <asp:HiddenField runat="server" ID="hdnCardName" />
                                </div>

                                <div class="form-group col-md-6">
                                    <label>
                                        <%=ResourceMgr.GetMessage("Card Type") %>
                                    </label>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <asp:Label runat="server" ID="lblCreditCardNumber"></asp:Label>
                                </div>

                                <div class="form-group col-md-6">
                                    <label>
                                        <%= ResourceMgr.GetMessage("Expiry Date")%>
                                    </label>
                                    <asp:Label runat="server" ID="lblCardExpiryDate"></asp:Label>
                                </div>
                            ...
                            <div class="row col-md-12">
                                <div class="form-group col-md-4">
                                    ...
                                    <asp:TextBox runat="server" ID="txtAmountCreditCard" CssClass="form-control" onkeypress="return ValidateNumberic(event);"></asp:TextBox>
                                    <cc1:ResourceCustomValidator runat="server" ID="rcvtxtAmountCreditCard" ControlToValidate="txtAmountCreditCard" ClientValidationFunction="validateAmount" ValidationGroup="CreditCard" ErrorMessage="Payment Amount should not be greater than invoice amount." CssClass="custom-error"></cc1:ResourceCustomValidator>
                                    <cc1:ResourceRequiredFieldValidator runat="server" ID="ResourceRequiredFieldValidator6" ControlToValidate="txtAmountCreditCard" ErrorMessage="Please Enter Amount" CssClass="custom-error" ValidationGroup="CreditCard"></cc1:ResourceRequiredFieldValidator>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <cc1:ResourceLinkButton CssClass="btn btn-primary btn-sm" ID="btnInvoicePaymentCreditCard" runat="server" ValidationGroup="CreditCard" OnClick="btnInvoicePaymentCreditCard_Click" Visible="false"><%=ResourceMgr.GetMessage("Pay") %></cc1:ResourceLinkButton>

                        <cc1:ResourceLinkButton CssClass="btn btn-primary btn-sm" ID="btnInvoicePaymentCheck" runat="server" ValidationGroup="Check" OnClick="btnInvoicePaymentCheck_Click" Visible="false"><%=ResourceMgr.GetMessage("Pay") %></cc1:ResourceLinkButton>
                ...
                <div class="ajaxModal-body animated bounceInRight">
                    ...
                    <div class="modal-body">
                        ...
                        <div role="form" class="row search-filter" runat="server" id="frmPaymentDetail">
                            ...
                            <div class="form-group col-md-6">
                                <asp:Label ID="lblForCheckorCreditCard" runat="server" Style="font-weight: bold;"></asp:Label>
                ...
                <div class="ajaxModal-body animated bounceInRight">
                    ...
                    <div class="modal-footer">
                        ...
                        <%--<cc1:ResourceLinkButton CssClass="btn btn-primary btn-sm" ID="lnkEmail" runat="server"
                            OnClientClick="visibleDiv()"><%=ResourceMgr.GetMessage("Email") %></cc1:ResourceLinkButton>--%>
