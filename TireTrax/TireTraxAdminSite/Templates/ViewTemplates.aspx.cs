...
public partial class Templates_ViewTemplates : BasePage
{
    ...
    protected void gvTemplateinfo_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            ImageButton Imgbtntemplate = (ImageButton)e.Row.FindControl("Imgbtntemplate");
            ImageButton imgbtnEdit = (ImageButton)e.Row.FindControl("imgbtnEdit");
            ImageButton imgBtneDeactivate = (ImageButton)e.Row.FindControl("imgBtneDeactivate");
            ImageButton imgbtnActivate = (ImageButton)e.Row.FindControl("imgbtnActivate");
